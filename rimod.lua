...
function RayfieldLibrary:CreateWindow(Settings)
	if Rayfield:FindFirstChild('Loading') then
		if getgenv and not getgenv().rayfieldCached then
			...
			-- Remove splash screen: hide it immediately instead of waiting
	...
	-- REMOVE ALL LOADING ANIMATIONS: Show UI instantly
	LoadingFrame.Visible = false
	Topbar.Visible = true
	Elements.Visible = true

	-- Set final sizes and transparency
	...
	-- No loading animation; UI is already visible
